...
void parametros()
{
  ...
  do{
    Open_channel(ph1);
    Serial3.print(tempC); //Para se obter um valor compensado pode-se enviar um valor de temperatura da ÃƒÂ¡gua.
    Serial3.print('\r');
    delay(500);
...
void iniciar_stamps()
{
  ...
  delay(1000);
  Serial3.flush();
  Serial3.print("L0"); // Envia um comando para que o "stamp" apague o led de depuraÃƒÂ§ÃƒÂ£o.
  Serial3.print('\r');
  delay(1000);
  Open_channel(ph2);
  delay(50);
