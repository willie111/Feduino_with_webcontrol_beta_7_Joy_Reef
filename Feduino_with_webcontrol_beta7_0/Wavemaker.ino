...
/************** lines below were added to reduce wave pump power after lights out at night time *****************************************/
/************************** for no wave power change at night time, comment out the section below ***************************************/

  if((bled_out == 0) && (wled_out == 0) && (rbled_out  == 0) && (rled_out == 0) && (uvled_out == 0))
  {
  analogWrite(wavemaker1, int(Pump1PWM * 0.50)); // 0.50 for 50% power, change to 0.75 for 75% power, change to 0.25 for 25% power
  analogWrite(wavemaker2, int(Pump2PWM * 0.50)); // 0.50 for 50% power, change to 0.75 for 75% power, change to 0.25 for 25% power
  }
  else
  {
