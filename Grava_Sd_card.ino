...
void logphagraf() //Grava dados no SD CARD para gerar  grÃƒÂ¡fico de PH do aquÃƒÂ¡rio.
{ 
  char oldminuto2;
  oldminuto2 = time2;
  time2 = t.min;
...
void logphrgraf() //Grava dados no SD CARD para gerar  grÃƒÂ¡fico de PH do reator de calcio.
{
  char oldminuto3;
  oldminuto3 = time3;
  time3 = t.min;
